			...
			<div role="main" class="col-md-8">
					<div class="form-group">
						<label for="inputImage">Imagem</label> <input type="file"
							accept="image" name="imagem" id="inputImage" value="${contato.imagem}" disabled/>
					</div>
					<div class="form-group">
						<label for="inputName">Nome</label> <input type="text"
							class="form-control" name="nome" id="inputName" value="${contato.nome}" disabled/>
					</div>
					<div class="form-group">
						<label for="inputEmail">E-mail</label> <input type="email"
							class="form-control" name="email" id="inputEmail" value="${contato.email}" disabled/>
					</div>
					<div class="form-group">
						<label for="inputTelefone">Telefone</label> <input type="text"
							class="form-control" name="telefone" id="inputTelefone" value="${contato.telefone}" disabled />
					</div>
					<div class="form-group">
						<label for="inputData">Data de Nascimento</label> <input
							type="text" class="form-control" name="data" id="inputData" required value="${data}" disabled/>
					</div>
					<div class="form-group">
						<label for="inputApresentacao">Texto de Apresentação</label>
						<textarea id="inputApresentacao" class="form-control" name="texto" rows="10" disabled>${contato.texto}</textarea>
					</div>
					<script>
                        jQuery(function() {
					...
					<a href="mvc?action=ListaContatoAction"><input type="button" class="btn btn-default" value="Voltar" /></a>
			</div>
